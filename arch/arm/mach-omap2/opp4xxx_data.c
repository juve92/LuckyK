...
#define OMAP4460_VDD_MPU_OPPTURBO_UV	1130000
#define OMAP4460_VDD_MPU_OPPNITRO_UV	1210000
#define OMAP4460_VDD_MPU_OPP_1_UV	1300000
#define OMAP4460_VDD_MPU_OPP_2_UV	1340000
#define OMAP4460_VDD_MPU_OPP_3_UV	1370000
...
#ifdef CONFIG_OMAP_SMARTREFLEX_CUSTOM_SENSOR
        VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP50_UV, 0, OMAP44XX_CONTROL_FUSE_CORE_OPP50, 0, 0, 0xf4, 0x0c, OMAP_ABB_NONE),
        VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP75_UV, 13000, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0, 0, 0xf9, 0x16, OMAP_ABB_NONE),
        VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP100_UV, 19000, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0, 0, 0xf9, 0x16, OMAP_ABB_NONE),
        VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP100_OV_UV, 24000, OMAP44XX_CONTROL_FUSE_CORE_OPP100OV, 0, 0, 0xf9, 0x16, OMAP_ABB_NONE),
        VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0, 0, 0),
#else
	VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP50_UV, 0, OMAP44XX_CONTROL_FUSE_CORE_OPP50, 0xf4, 0x0c, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP75_UV, 13000, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16, OMAP_ABB_NONE),
        VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP100_UV, 19000, OMAP44XX_CONTROL_FUSE_CORE_OPP100OV, 0xf9, 0x16, OMAP_ABB_NONE),
        VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP100_OV_UV, 24000, OMAP44XX_CONTROL_FUSE_CORE_OPP100OV, 0xf9, 0x16, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
#endif
};
