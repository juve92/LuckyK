...
#define OMAP4460_VDD_MPU_OPP100_UV	1020000
#define OMAP4460_VDD_MPU_OPPTURBO_UV	1150000
#define OMAP4460_VDD_MPU_OPPNITRO_UV	1230000
#define OMAP4460_VDD_MPU_OPP_1_UV	1280000
#define OMAP4460_VDD_MPU_OPP_2_UV	1320000
#define OMAP4460_VDD_MPU_OPP_3_UV	1350000
#define OMAP4460_VDD_MPU_OPPUBER_UV	1380000
#define OMAP4460_VDD_MPU_OPPFIRE_UV	1400000
...
#define OMAP4460_VDD_IVA_OPP50_UV		 870000
#define OMAP4460_VDD_IVA_OPP100_UV		 980000
#define OMAP4460_VDD_IVA_OPPTURBO_UV		1271000
#define OMAP4460_VDD_IVA_OPPNITRO_UV		1355000
#define OMAP4460_VDD_IVA_OPPNITROSB_UV		1356000
...
#define OMAP4460_VDD_CORE_OPP50_UV	 960000
#define OMAP4460_VDD_CORE_OPP75_UV	1050000
#define OMAP4460_VDD_CORE_OPP100_UV	1096000
#define OMAP4460_VDD_CORE_OPP100_OV_UV  1105000
#define OMAP4460_VDD_CORE_OPP100_OC_UV	1137000
...
struct omap_volt_data omap446x_vdd_core_volt_data[] = {
        ...
        VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP100_UV, 14000, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0, 0, 0xf9, 0x16, OMAP_ABB_NONE),
        VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP100_OV_UV, 46000, OMAP44XX_CONTROL_FUSE_CORE_OPP100OV, 0, 0, 0Xf9, 0x16, OMAP_ABB_NONE),
        VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP100_OC_UV, 75000, OMAP44XX_CONTROL_FUSE_CORE_OPP100OC, 0, 0, 0xf9, 0x16, OMAP_ABB_NONE),
        VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0, 0, 0),
#else
	...
	VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP75_UV, 13000, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16, OMAP_ABB_NONE),
        ...
        VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP100_OV_UV, 46000, OMAP44XX_CONTROL_FUSE_CORE_OPP100OV, 0Xf9, 0x16, OMAP_ABB_NONE),
        VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP100_OC_UV, 75000, OMAP44XX_CONTROL_FUSE_CORE_OPP100OV, 0xf9, 0x16, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
#endif
};
...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
	...
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 438000000, OMAP4460_VDD_CORE_OPP100_OV_UV),
#ifdef CONFIG_OMAP4460_GPU_OVERCLOCK
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 512000000, OMAP4460_VDD_CORE_OPP100_OC_UV),
#endif
	/* FDIF OPP1 - OPP25 */
